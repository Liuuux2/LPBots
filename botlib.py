...
class CraftPlayer :
    ...
    def _action (OO0OOOO0O00O0OO00 ):
        ...
        try :
		    ...
		    OO0OOOO0O00O0OO00 .SendPacket ('\x01'+CraftString ("/register asdasidijasdijoaiosdjio"))
		    OO0OOOO0O00O0OO00 .SendPacket ('\x01'+CraftString ("/register asdasidijasdijoaiosdjio"))
    ...
    def _connect (O0OOOOO00OOO00000 ):
	    ...
	    O0OOOOO00OOO00000 .SendPacket ('\xFE'+encode_varint (O0OOOOO00OOO00000 ._protonum )+CraftString (_O0O0OO0OOO0000O0O )+struct .pack ('>h',_O0O0O00OO0OOOO000 )+encode_varint (1 )) #Bad Login Packet At LoginRequestEvent FlameCord
            O0OOOOO00OOO00000 .SendPacket ('\x00'+encode_varint (O0OOOOO00OOO00000 ._protonum )+CraftString (_O0O0OO0OOO0000O0O )+struct .pack ('>h',_O0O0O00OO0OOOO000 )+encode_varint (1 )) #Sends PING instead of STATUS packet
            ...
            if OO00O0OO0OOO0000O ._isConnected ==False :
                ...
                if _O000O0O00000O0000 ==0x00 :
                    ...
                    if OO00O0OO0OOO0000O ._loggedIn ==False :
                        ...
                        if O000OOOOOOO0OO0O0 .find ('1 + 1')!=-1 :
                            OO00O0OO0OOO0000O ._log ('Captcha! - '+O000OOOOOOO0OO0O0)
                            OO00O0OO0OOO0000O ._queuedMessages .append ('2')
                            OO00O0OO0OOO0000O ._queuedMessages .append ('DEAH')
                            OO00O0OO0OOO0000O ._loggedIn =True
                            OO00O0OO0OOO0000O ._log ('Done Captcha')
                        if O000OOOOOOO0OO0O0 .find ('2 + 2')!=-1 :
                            OO00O0OO0OOO0000O ._log ('Captcha! - '+O000OOOOOOO0OO0O0)
                            OO00O0OO0OOO0000O ._queuedMessages .append ('4')
                            OO00O0OO0OOO0000O ._queuedMessages .append ('DEAH 2')
                            OO00O0OO0OOO0000O ._loggedIn =True
                            OO00O0OO0OOO0000O ._log ('Done Captcha')
                elif _O000O0O00000O0000 ==0x03 :
